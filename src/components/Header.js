                    ...
                    <div className="row gx-5 align-items-center justify-content-center">
                        <div className="col-lg-8 col-xl-7 col-xxl-6 pb-4">
                            <div className="text-center text-xl-start">
                                <h1 className="display-5 fw-bolder text-white mb-2">Dress Dash is a vibrant and stylish e-commerce</h1>
                                <p className="lead fw-normal text-white-50 mb-4">"Dress Dash" is a vibrant and stylish e-commerce web application that caters to all your fashion needs. With a wide range of clothing, accessories, and footwear, Dress Dash offers a one-stop shopping experience for individuals who want to express their unique style and stay up-to-date with the latest fashion trends.</p>
